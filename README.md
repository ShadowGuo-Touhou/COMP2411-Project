...
    2. a function that returns the name of a all tables: getTables()--> list;

    3. a function that returns the content of a table by name getTableContent(tableName: str) --> list;
